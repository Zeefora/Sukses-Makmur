...
export const AuthProvider = ({ children }) => {
    ...
    // Hydrate dari localStorage setelah mount (client only)
    useEffect(() => {
        try {
            const savedUser = localStorage.getItem('sm_currentUser');
            const savedUsers = localStorage.getItem('sm_registeredUsers');
    ...
    return (
        <AuthContext.Provider value={{ currentUser, registeredUsers, login, register, logout, isHydrated }}>
            {children}
